...
```bash
python ${CLAUDE_PLUGIN_ROOT}/hooks/launch_dashboard.py
```
...
```bash
DASHBOARD_PORT=9090 python ${CLAUDE_PLUGIN_ROOT}/hooks/launch_dashboard.py
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/dashboard/server.py
```
